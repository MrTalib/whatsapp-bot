...
Добрый день${salam} ${pushname} хорошего дня😉
...
*ТОЛЬКО ГРУППА*
*${p+=1}.* ${prefix}группу _открой|закрой_
...
*${p+=1}.* ${prefix}удали _@tag_
*${p+=1}.* ${prefix}добавь _number_
*${p+=1}.* ${prefix}getpp _@tag_
*${p+=1}.* ${prefix}участники
...
const ingfo = `Проект IT-World:
https://telegra.ph/𝕀𝕋-𝕎𝕠𝕣𝕝𝕕-09-22

Telegram 
https://t.me/vedroiapk

YouTube 
https://youtube.com/channel/UC8AuhEwduVvge-lNXWqFNjw
...
const mess = {
			 ...
			 admin: 'только админ!',
			 botAdmin: 'эту команду можно использовать, только если бот входит в группу админов',
			 limit: 'Limit penggunaan anda sudah habis, \n\nNote: limit akan direset setiap 00.00',
			 ownerOnly: 'Эта команда предназначена только для владельца!'
}
